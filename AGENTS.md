...
4. **Read [`docs/pilots/c-4/phase-a-retro.md`](docs/pilots/c-4/phase-a-retro.md) and the C-4 pilot brief at `../devai-adoption-by-stynx.md`** — context for how stynx adopts DEVAI and which gaps (D-A-1 … D-A-9) are filed for follow-up devai sessions.
