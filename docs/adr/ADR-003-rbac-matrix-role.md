...
**Authority:** Architect.
**Related:** `INV-RBAC-001`, `docs/RBAC Matrix.md`, `docs/KNOWN_GAPS.md`.
...
`docs/RBAC Matrix.md` was generated from a sensor snapshot. Older audits treated
...
`docs/RBAC Matrix.md` is a generated diagnostic and template artifact for the
...
- Empty counts in `docs/RBAC Matrix.md` are a reference-app inventory gap, not
  proof that STYNX lacks RBAC primitives.
- `docs/KNOWN_GAPS.md` should route matrix binding gaps to the reference-app
