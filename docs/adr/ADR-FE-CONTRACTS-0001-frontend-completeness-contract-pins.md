...
**Authority:** Architect.
**Related:** [`docs/contracts/auth-hosted-actions.md`](../contracts/auth-hosted-actions.md), [`docs/contracts/audit-events-api.md`](../contracts/audit-events-api.md), [`docs/contracts/flow-api.md`](../contracts/flow-api.md).
