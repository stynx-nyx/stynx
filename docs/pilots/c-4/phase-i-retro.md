...
| **F-2**  | `/specs/` migration into `docs/adr/` + `docs/arch/`                                                        | G                     | Deferred — 15 ADRs/specs to consolidate per-spec                                     |
| **F-3**  | `docs/gov/{health,audit,compliance}` migration into `.devai/state/`                                        | G                     | Deferred — multiple files, careful ownership transitions                             |
...
| S5-3    | `343a5c1`                  | `docs/gov/` archived to `docs/legacy/governance-archive/`                                                                                                                                                                            |
...
- All legacy stynx governance machinery is either folded in or formally archived (every file under `/specs/`, `docs/gov/`, `.codex/{prompts,system.md}`, plus 2 of 3 `.codex/skills/`).
...
| **F3×T4**     | REVIEW | PASS                    | Added `tests[]` entries to `docs/arch/trace.json` for INV-RBAC-001 (3 test paths) + INV-PRIVACY-001 (2 test paths)                                                                                                                                                                                                                                                                                               |
...
| **F1×T3** | REVIEW             | **PASS**             | (a) Added `tests[]` entries to `docs/arch/trace.json` for INV-COVERAGE-001, INV-PERF-001, INV-ERROR-001 (the 3 invariants promoted in U6). (b) Renamed `INV-RBAC-001-allowlist.json` → `RBAC-001-allowlist.data.json` so trace-resolve no longer scans it as an invariant. Updated 2 cross-references.                                                                                               |
