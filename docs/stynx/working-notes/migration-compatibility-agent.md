...
- `stynx/packages/stynx-backend/src/auth/auth-context.guard.ts`
- `stynx/packages/stynx-backend/src/authorization/authorization.guard.ts`
- `stynx/packages/stynx-backend/src/db-context/db-context.interceptor.ts`
...
Implemented in:
- `stynx/packages/stynx-backend/src/authorization/authorization.guard.ts`
- `stynx/packages/stynx-backend/src/authorization/default-policy-evaluator.ts`
