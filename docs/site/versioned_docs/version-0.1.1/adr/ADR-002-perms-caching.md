...
**Authority:** Architect.
**Related:** [`docs/arch/STYNX-SPEC-v0.6.md`](/docs/arch/STYNX-SPEC-v0.6) §5, §6, §7, §12. Pre-pilot history: file was at `specs/STYNX-ADR-002-perms-caching.md` until C-4 Session S5 (commit `cb734ac`); re-authored to DEVAI ADR schema in C-4 Session T3.
