...
The shared template is [../templates/package-README.md](/docs/templates/package-README).
...
or platform permission catalog. See [ADR-003](/docs/adr/ADR-003-rbac-matrix-role).
