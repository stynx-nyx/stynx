...
- [../security/](/docs/security) covers threat model and security posture.
- [../ops/](/docs/ops) covers operational runbooks and recovery.
- [../stynx/package-architecture.md](/docs/narrative/stynx/package-architecture) is the
