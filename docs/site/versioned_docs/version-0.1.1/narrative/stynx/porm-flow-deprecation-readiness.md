---
title: 'PORM Flow Deprecation Readiness'
---
...
2. Align package versions:
   ...
   - add `@stynx-nyx/angular-flow` to the PORM frontend workspace;
...
7. Removal:
   ...
   - update PORM docs to mark local Flow as deprecated by `@stynx-nyx/flow` and `@stynx-nyx/angular-flow`.
