...
The generated artifact is `docs/meta/security/sbom.cdx.json` in CycloneDX JSON
...
`docs/meta/security/license-policy.json` is the allow/deny policy for direct
