...
The F1 paths each role authors in STYNX are enumerated in [`AGENTS.md`](../meta/agents.md) and [`CLAUDE.md`](../meta/claude.md). For the canonical role definitions, see [DEVAI's Roles section](https://aarusso-nyx.github.io/devai/docs/roles/).
