...
[@stynx-nyx/backend](../index.md) / SlaMonitorInterceptorOptions

# Interface: SlaMonitorInterceptorOptions

Defined in: [packages/backend/src/sla/types.ts:34](https://github.com/aarusso-nyx/stynx/blob/f54a7f51a22215c0ee06c6f06d8420d5b798763d/packages/backend/src/sla/types.ts#L34)

## Extended by

- [`StynxSlaModuleOptions`](StynxSlaModuleOptions.md)
