...
**Produces:** `docs/stynx/porting-pack/99-PROVENANCE.md` and updates
`docs/stynx/porting-pack/00-README.md` to reflect the now-populated pack.
**Depends on:** all prior pack files.
**Branch:** `docs/stynx/porting-pack/99-finalize`.
...
3. Compute pack word count: `wc -w docs/stynx/porting-pack/**/*.md`.
...
&gt; Pack at `docs/stynx/porting-pack/`. NN files. NNNN words. Top open gap:
