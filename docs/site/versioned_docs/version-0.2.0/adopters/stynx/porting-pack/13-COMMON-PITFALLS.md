...
&gt; - `internal work note (not published)`
...
- **Fix:** Treat Cognito provisioning as a Phase-3 runbook entry,
  ...
  Document this in `docs/meta/ops/runbooks/cognito-cutover.md`
...
- **Detection:**
  ...
  test -f docs/meta/ops/runbooks/cognito-cutover.md \
...
- **FIND-031** — operations runbooks absent. Pitfall #7's "Fix"
  references `docs/meta/ops/runbooks/cognito-cutover.md`; that
