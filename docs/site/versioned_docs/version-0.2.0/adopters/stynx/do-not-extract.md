...
- Product-specific workflow semantics:
  ...
  - The generic Flow machinery has been extracted into `@stynx-nyx/flow` and `@stynx-nyx/angular-flow`; do not copy PORM-specific policies back into the framework packages.
