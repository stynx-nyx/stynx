...
- Package: `@stynx-nyx/pdf` v0.1.0 workspace state with
...
- Surface changes:
  ...
  - Subpath exports: `@stynx-nyx/pdf/fixed-layout` and
    `@stynx-nyx/pdf/public-payroll`.
...
- Commands:
  ...
  - `pnpm --filter @stynx-nyx/pdf typecheck`
  - `pnpm --filter @stynx-nyx/pdf lint`
  - `pnpm --filter @stynx-nyx/pdf build`
