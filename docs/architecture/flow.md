...
| `../porm/docs/engineering/domains/flow/*.md`                            | Human documentation of schema, backend, frontend, and workflow behavior                                             | Provides invariants, vocabulary, and acceptance expectations                                                                                        |
