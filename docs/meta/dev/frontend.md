...
- Porting an existing non-Angular frontend: keep the app framework and use [`@stynx-web/sdk`](/docs/packages-web/sdk); the porting-specific checklist lives in [`09-FRONTEND-PATTERNS.md`](../../adopters/stynx/porting-pack/09-FRONTEND-PATTERNS.md).
...
| -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| Typed HTTP without Angular                         | [`@stynx-web/sdk`](/docs/packages-web/sdk)                                                                                               | Porting-pack SDK path in [`09-FRONTEND-PATTERNS.md`](../../adopters/stynx/porting-pack/09-FRONTEND-PATTERNS.md) |
