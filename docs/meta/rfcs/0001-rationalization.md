...
Move behavior into `packages/*`, `packages-web/*`, `apps/*`, and `tools/*`; delete legacy top-level workspaces; and keep audit evidence under `docs/work/rationalization/`.
...
- [Rationalization work](../../work/rationalization/)
