...
| `../porm/docs/meta/eng/domains/flow/*.md`                               | Human documentation of schema, backend, frontend, and workflow behavior                                             | Provides invariants, vocabulary, and acceptance expectations                                                                                        |
...
contract in `docs/framework/contracts/flow-api.md` is stable: Angular clients see
...
- a tested API facade for every route family in `docs/framework/contracts/flow-api.md`, including aliases;
...
- An API facade over `@stynx-nyx/sdk` using the backend contract in `docs/framework/contracts/flow-api.md`.
...
- backend route permission tests covering every route family in `docs/framework/contracts/flow-api.md`;
