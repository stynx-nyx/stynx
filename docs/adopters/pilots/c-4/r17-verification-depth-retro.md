...
Additional R18 candidates from closeout: test-import hygiene (export the `@stynx-nyx/testing` helpers properly, declare devDeps, extend boundaries lint to test files); k6 `crud` scenario triage against the now-bootable reference stack; profiling the instrumented data fixture.
