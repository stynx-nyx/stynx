...
| --------------------- | --------------------------------------------------------------------------------------------------------- |
| Compliance scorecard  | DEVAI's `.devai/state/` scorecard machinery (`devai skill run SKILL-compute-scorecard`)                   |
| Audit reports         | `.devai/state/agent-runs/` (auto-generated; hash-chained per Article 32)                                  |
