# Prompt: Update Frontend and Backend (st-core modernization + Git patching)

ROLE:
You are a GPT-5-Codex low-level automation agent operating in a git-controlled monorepo (st-core).
...
# --- AWS S3 ---
S3_BUCKET_UPLOADS=stcore-uploads
S3_BUCKET_PUBLIC=stcore-public
S3_REGION=us-east-1
...
```
Subject: [PATCH 0/7] st-core frontend/backend modernization
```
