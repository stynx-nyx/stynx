...
- **Invariant** — an atomic architecture rule under
  [`../invariants/`](../invariants/). Tests and docs
...
- **Trace** — the mapping from invariants to code, tests, and documentation.
  The canonical trace lives in [`../trace.json`](../trace.json).
...
- **RBAC Matrix** — a generated diagnostic/template for current reference-app
  ...
  framework permission catalog; see [ADR-003](../adr/ADR-003-rbac-matrix-role.md).
