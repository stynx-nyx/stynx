...
-- Convention: `sample:resource:action`
-- ----------------------------------------------------------------------------
...
INSERT INTO auth.perms (key, description) VALUES
  ...
  ('sample:record-note:read', 'Read record notes.'),
  ('sample:record-note:write', 'Create or update record notes.'),
  ('sample:record-note:delete', 'Soft-delete record notes.'),
  ('sample:record-note:restore', 'Restore soft-deleted record notes.'),
  ('sample:record-note:hard-delete', 'Hard-delete archived record notes.'),

  ('sample:work-item:read', 'Read work items.'),
  ('sample:work-item:write', 'Create or update work items.'),
  ('sample:work-item:delete', 'Soft-delete work items.'),
  ('sample:work-item:restore', 'Restore soft-deleted work items.'),
  ('sample:work-item:hard-delete', 'Hard-delete archived work items.'),

  ('sample:work-item-entry:read', 'Read work item entries.'),
  ('sample:work-item-entry:write', 'Create or update work item entries.'),
  ('sample:work-item-entry:delete', 'Soft-delete work item entries.'),
  ('sample:work-item-entry:restore', 'Restore soft-deleted work item entries.'),
  ('sample:work-item-entry:hard-delete', 'Hard-delete archived work item entries.'),

  ('sample:work-item-lock:read', 'Read work item locks.'),
  ('sample:work-item-lock:write', 'Create or update work item locks.'),
  ('sample:work-item-lock:delete', 'Soft-delete work item locks.'),
  ('sample:work-item-lock:restore', 'Restore soft-deleted work item locks.'),
  ('sample:work-item-lock:hard-delete', 'Hard-delete archived work item locks.'),

  ('sample:document:read', 'Read document metadata and download URLs.'),
  ('sample:document:write', 'Create document uploads and complete them.'),
  ('sample:document:delete', 'Soft-delete documents.'),
...
BEGIN
  ...
  VALUES (gen_random_uuid(), 'sample-demo', 'Sample Demo Tenant', 'active', true, clock_timestamp(), clock_timestamp())
  RETURNING id INTO v_tid;

  INSERT INTO auth.users (id, email, external_subject, locale, created_at, updated_at)
  VALUES (gen_random_uuid(), 'admin@sample-demo.test', 'cognito-sub-seed-0001', 'pt-BR', clock_timestamp(), clock_timestamp())
  RETURNING id INTO v_uid;

  INSERT INTO auth.memberships (id, tenant_id, user_id, is_active, created_at)
  VALUES (gen_random_uuid(), v_tid, v_uid, true, clock_timestamp());
