...
This is the backend surface that powers `@stynx-nyx/angular-iam` (W07).
...
- [`@stynx-nyx/angular-iam`](/docs/packages-web/angular-iam/) — Angular admin UI consuming these endpoints.
