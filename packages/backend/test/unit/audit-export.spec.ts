// Smoke check: audit submodule's index.ts loads without runtime errors.
...
describe('@stynx/backend/audit export surface', () => {
  it('module barrel loads without throwing', async () => {
    await expect(import('../../src/audit/index')).resolves.toBeDefined();
  });
});
