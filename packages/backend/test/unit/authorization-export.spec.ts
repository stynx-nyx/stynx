// Smoke check: authorization submodule's index.ts loads without runtime errors.
...
describe('@stynx/backend/authorization export surface', () => {
  it('module barrel loads without throwing', async () => {
    await expect(import('../../src/authorization/index')).resolves.toBeDefined();
  });
});
