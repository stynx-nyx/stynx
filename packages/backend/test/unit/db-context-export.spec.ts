// Smoke check: db-context submodule's index.ts loads without runtime errors.
...
describe('@stynx/backend/db-context export surface', () => {
  it('module barrel loads without throwing', async () => {
    await expect(import('../../src/db-context/index')).resolves.toBeDefined();
  });
});
