...
onboarding. See [`AUDIT-REMEDIATION-09-operability-docs.md`](../docs/work/prompts/AUDIT-REMEDIATION-09-operability-docs.md).
...
| FIND-013 | **PARTIAL**                     | `.nvmrc` + `.mise.toml` pin engines; CI may still run on wrong version. |
