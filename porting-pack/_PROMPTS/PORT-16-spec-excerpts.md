...
**Produces:** `porting-pack/16-SPEC-EXCERPTS/*.md` (six files).
**Depends on:** `_DISCOVERY.md`.
**Branch:** `porting-pack/16-spec-excerpts`.
...
Each file lives under `porting-pack/16-SPEC-EXCERPTS/`. Each begins
...
```
ls porting-pack/16-SPEC-EXCERPTS/
wc -l porting-pack/16-SPEC-EXCERPTS/*.md
```
