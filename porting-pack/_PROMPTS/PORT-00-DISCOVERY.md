...
**Produces:** `porting-pack/_DISCOVERY.md` (notes; not a final pack artifact).
**Depends on:** nothing.
**Branch:** `porting-pack/00-discovery`.
...
## Write to `porting-pack/_DISCOVERY.md`
...
- `porting-pack/_DISCOVERY.md` exists.
...
```
ls -la porting-pack/_DISCOVERY.md
grep -c '(\(see\|file:\|\.ts\|\.md\|\.sql\)' porting-pack/_DISCOVERY.md
```
