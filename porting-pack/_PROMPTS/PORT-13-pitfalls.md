...
**Produces:** `porting-pack/13-COMMON-PITFALLS.md`.
**Depends on:** `06`, `08`.
**Branch:** `porting-pack/13-pitfalls`.
...
- `docs/work/audit/07-FINDINGS-REGISTER.md` (drift caught in audit).
- `docs/work/audit/13-COMMON-PITFALLS.md` if present.
