...
describe('FlowApiService endpoint contract', () => {
  it('covers design route families for scopes, graphs, nodes, edges, rules, effects, and form gates', async () => {
    ...
    expect(client.calls.map((call) => [call.method, call.path, call.options ?? null])).toEqual([
      ['GET', '/flow/scopes', null],
      ['GET', '/flow/scopes/scope-1', null],
      ['POST', '/flow/scopes', null],
      ['PATCH', '/flow/scopes/scope-1', null],
      ['DELETE', '/flow/scopes/scope-1', null],
      ['GET', '/flow/graphs', { query: { scopeId: 'scope-1' } }],
      ['GET', '/flow/graphs/graph-1', null],
      ['POST', '/flow/graphs', null],
      ['PATCH', '/flow/graphs/graph-1', null],
      ['POST', '/flow/graphs/graph-1/publish', { headers: { 'Idempotency-Key': 'publish-key' } }],
      ['DELETE', '/flow/graphs/graph-1', null],
      ['GET', '/flow/graphs/graph-1/export', null],
      ['POST', '/flow/graphs/import', null],
      ['GET', '/flow/graphs/graph-1/nodes', null],
      ['POST', '/flow/graphs/graph-1/nodes', null],
      ['PATCH', '/flow/nodes/node-1', null],
      ['DELETE', '/flow/nodes/node-1', null],
      ['GET', '/flow/graphs/graph-1/edges', null],
      ['POST', '/flow/graphs/graph-1/edges', null],
      ['PATCH', '/flow/edges/edge-1', null],
      ['DELETE', '/flow/edges/edge-1', null],
      ['GET', '/flow/nodes/node-1/agent-rules', null],
      ['POST', '/flow/nodes/node-1/agent-rules', null],
      ['PATCH', '/flow/agent-rules/rule-1', null],
      ['DELETE', '/flow/agent-rules/rule-1', null],
      ['GET', '/flow/graphs/graph-1/transition-effects', null],
      ['POST', '/flow/graphs/graph-1/transition-effects', null],
      ['PATCH', '/flow/transition-effects/effect-1', null],
      ['DELETE', '/flow/transition-effects/effect-1', null],
      ['GET', '/flow/nodes/node-1/form-rules', null],
      ['POST', '/flow/nodes/node-1/form-rules', null],
      ['PATCH', '/flow/node-form-rules/form-rule-1', null],
      ['DELETE', '/flow/node-form-rules/form-rule-1', null],
    ]);
  ...
  it('covers forms, fills, answers, waivers, policies, analytics, signal, and effect routes', async () => {
    ...
    expect(client.calls.map((call) => [call.method, call.path, call.options ?? null])).toEqual([
      ['GET', '/flow/forms', { query: { scopeId: 'scope-1' } }],
      ['GET', '/flow/forms/form-1', null],
      ['POST', '/flow/forms', null],
      ['PATCH', '/flow/forms/form-1', null],
      ['DELETE', '/flow/forms/form-1', null],
      ['GET', '/flow/forms/form-1/questions', null],
      ['POST', '/flow/forms/form-1/questions', null],
      ['PATCH', '/flow/questions/question-1', null],
      ['DELETE', '/flow/questions/question-1', null],
      ['GET', '/flow/questions/question-1/score', null],
      ['PUT', '/flow/questions/question-1/score', null],
      ['DELETE', '/flow/questions/question-1/score', null],
      ['GET', '/flow/fills', { query: { formId: 'form-1', targetId: 'target-1' } }],
      ['GET', '/flow/fills/fill-1', null],
      ['GET', '/flow/forms/form-1/fills/fill-1', null],
      ['POST', '/flow/forms/form-1/fills', null],
      ['POST', '/flow/fills', null],
      ['PATCH', '/flow/fills/fill-1', null],
      ['DELETE', '/flow/fills/fill-1', null],
      ['GET', '/flow/fills/fill-1/answers', null],
      ['GET', '/flow/forms/form-1/fills/fill-1/answers', null],
      ['POST', '/flow/fills/fill-1/answers', null],
      ['PUT', '/flow/fills/fill-1/answers', null],
      ['PATCH', '/flow/answers/answer-1', null],
      ['DELETE', '/flow/answers/answer-1', null],
      ['GET', '/flow/waivers', { query: { formId: 'form-1' } }],
      ['GET', '/flow/fills/fill-1/waivers', null],
      ['GET', '/flow/forms/form-1/fills/fill-1/waivers', null],
      ['POST', '/flow/waivers', null],
      ['POST', '/flow/forms/form-1/fills/fill-1/waivers', null],
      ['PATCH', '/flow/waivers/waiver-1', null],
      ...
      ['GET', '/flow/policies/sets/policy-set-1', null],
      ['POST', '/flow/policies/sets', null],
      ['PATCH', '/flow/policies/sets/policy-set-1', null],
      ['DELETE', '/flow/policies/sets/policy-set-1', null],
      ['GET', '/flow/policies/sets/policy-set-1/rules', null],
      ['GET', '/flow/policies/rules/policy-rule-1', null],
      ['POST', '/flow/policies/sets/policy-set-1/rules', null],
      ['PATCH', '/flow/policies/rules/policy-rule-1', null],
      ['DELETE', '/flow/policies/rules/policy-rule-1', null],
      ['POST', '/flow/policies/evaluate', null],
    ]);
  ...
  it('covers runtime, task action, candidate, user lookup, and event routes', async () => {
    ...
    expect(client.calls.map((call) => [call.method, call.path, call.options ?? null])).toEqual([
      ['GET', '/flow/runs', { query: { scopeId: 'scope-1' } }],
      ['POST', '/flow/runs/ensure', null],
      ['GET', '/flow/runs/run-1', null],
      ['PATCH', '/flow/runs/run-1', null],
      ...
      ['GET', '/flow/events', { query: { runId: 'run-1', kind: 'task_done' } }],
      ['GET', '/flow/tasks', { query: { mine: true, status: 'open' } }],
      ['GET', '/flow/tasks', { query: { status: 'open', mine: true } }],
      ['GET', '/flow/tasks', { query: { status: 'open', assigneeUserId: 'user-1' } }],
      ['GET', '/flow/tasks/task-1', null],
      ['GET', '/flow/tasks/task-1/candidates', null],
      ['GET', '/flow/tasks/roles/reviewer/users', { query: { search: 'ana' } }],
      ['GET', '/flow/tasks/users/user-1', null],
      ['POST', '/flow/tasks/task-1/accept', null],
      ['POST', '/flow/tasks/task-1/decline', null],
      ['POST', '/flow/tasks/task-1/unaccept', null],
      ['POST', '/flow/tasks/task-1/withdraw', null],
      ['POST', '/flow/tasks/task-1/act', null],
      ['POST', '/flow/tasks/task-1/assign', null],
      ['POST', '/flow/tasks/task-1/unassign', null],
    ]);
